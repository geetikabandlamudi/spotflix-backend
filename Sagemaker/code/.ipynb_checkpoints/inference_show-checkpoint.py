...
audio_wavs = ['brahms', 'humpback', 'fishin', 'choice', 'libri1', 'libri2', 'libri3', 'nutcracker', 'pistachio', 'robin', 'sweetwaltz', 'vibeace']
...
def predict_fn(audio_path, model):
    my_bucket = 'dataset-bucket'
    s3 = boto3.resource('s3')
    s3.Bucket(my_bucket).download_file(audio_path, "./temp.mp4")
    y, sr = librosa.load("./temp.mp4", mono=True, sr=22050)
